...
import {
  CreateUserDto,
  UserSummaryDto,
} from "@/modulos/identity/application/dto/user.dto";
...
import { TenantMapper } from "@/modulos/identity/domain/mappers/tenant.mapper";
...
import { TenantRepository } from "@/modulos/identity/domain/repositories/tenant.repository";
