...
import { CreateAccountInputDto } from "../../dto/account/create-account.input.ts";
import { CreateAccountOutputDto } from "../../dto/account/create-account.output";
...
export class CreateAccountUseCase {
  ...
  async execute(
    ...
    return right({
      user: UserMapper.toPresenter(saveUser),
    });
  }
}
