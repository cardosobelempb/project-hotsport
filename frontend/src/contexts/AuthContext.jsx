...
export function AuthProvider({ children }) {
  ...
  const updateEmpresaNome = (nome) => {
    setUser(prev => (prev ? { ...prev, empresa_nome: nome } : prev));
  };
  ...
  return (
    <AuthContext.Provider value={{ user, login, logout, loading, isSuperAdmin, empresas, switchEmpresa, permissoes, hasPermission, updateEmpresaNome }}>
      {children}
