...
import CadastroTrialTempo from "./pages/public/CadastroTrialTempo";
import CampanhaPreAcesso from "./pages/public/CampanhaPreAcesso";
import PortalReconexao from "./pages/public/PortalReconexao";
import AcessoAtivo from "./pages/public/AcessoAtivo";
import EscolhaAcesso from "./pages/public/EscolhaAcesso";
import CampanhaPopupPage from "./pages/public/CampanhaPopupPage";
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/trial-tempo" element={<CadastroTrialTempo />} />
      <Route path="/campanha-pre-acesso" element={<CampanhaPreAcesso />} />
      <Route path="/reconectar" element={<PortalReconexao />} />
      <Route path="/acesso-ativo" element={<AcessoAtivo />} />
      <Route path="/escolha-acesso" element={<EscolhaAcesso />} />
      <Route path="/campanha-popup" element={<CampanhaPopupPage />} />
